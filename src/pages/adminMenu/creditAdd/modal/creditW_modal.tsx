...
export const CreditWithDrawModal: React.FC<IModalProps> = ({
  setWithDrawModal,
}) => {
  const {
    register,
  ...
  return (
    <div
      ...
      className='fixed top-0 right-0 bottom-0 left-0 z-1000 overflow-auto outline-0'
    >
          ...
          <div className=''>
            <div className='lg:col-span-2'>
              <div className='border rounded-t-md border-red-600 font-medium text-lg px-6 py-2 border-b flex flex-row justify-center bg-red-600'>
                <div className='text-white text-xl font-bold'>크레딧 인출</div>
              </div>
