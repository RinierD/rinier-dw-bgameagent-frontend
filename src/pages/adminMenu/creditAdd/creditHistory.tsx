                ...
                {table.getHeaderGroups().map((headerGroup) => (
                  <tr key={headerGroup.id}>
                    {headerGroup.headers.map((header, index) => {
                      if (
                        header.column.columnDef.header === t('변경전크레딧') ||
                        header.column.columnDef.header === t('변경금액') ||
                        header.column.columnDef.header === t('변경후크레딧')
                      ) {
                        return (
                          <th
                            key={`sort_${index}`}
                ...
                {table.getRowModel().rows.map((row, index) => (
                  ...
                  >
                    {row.getVisibleCells().map((cell) => {
                      if (cell.column.columnDef.header === t('변경전크레딧')) {
                        return (
                          <td
                        ...
                        cell.column.columnDef.header === t('변경후크레딧')
                      ) {
                        return (
                          <td
                            key={`createdAt_${cell.id}`}
