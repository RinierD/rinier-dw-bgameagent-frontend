...
export const AccntSubBetLimitModal: React.FC<IModalProps> = () => {
					...
					<div className=''>
						<div className='lg:col-span-2'>
							<div className='border rounded-t-md font-medium text-lg px-6 py-3 border-b flex flex-row justify-between bg-gray-100'>
								<div className='text-gray-500 font-bold'>배팅한도</div>
								<GrClose
									...
									<div className='grid grid-cols-2 gap-4'>
										<div className='form-group mb-3 flex'>
											<div className='flex flex-row items-center'>
												<div className='text-gray-500 w-12 mr-1'>계정명:</div>
											</div>
											<div className='pl-2 w-40'>{memberData?.user_id}</div>
										</div>
									</div>
									<div>
										<div className='py-3'>
														...
														>
															{row.getVisibleCells().map((cell) => {
																if (
																	...
																	cell.column.columnDef.header === '타이'
																) {
																	return (
																		<td
																			key={`cell_${cell.id}`}
																	...
																	cell.column.columnDef.header === '페어'
																) {
																	return (
																		<td
																			key={`cell_${cell.id}`}
									...
									<div className='w-full flex justify-end'>
										<div className='' onClick={clickModalClose}>
											<button className='border border-gray-500 rounded-md py-2 px-7 font-bold text-md text-gray-600 flex items-center bg-gray-100'>
												...
												<div className='font-bold text-base'>닫기</div>
											</button>
										</div>
									</div>
								</form>
