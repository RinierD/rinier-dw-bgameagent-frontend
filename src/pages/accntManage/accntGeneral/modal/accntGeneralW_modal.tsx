...
export const AccntGenWithDrawModal: React.FC<IModalProps> = ({
	setWithDrawModal,
}) => {
	...
	const clickModalClose = () => {
		setWithDrawModal((current) => !current);
	};
					...
					<div className=''>
						<div className='col-span-2 lg:col-span-2'>
							<div className='border rounded-t-md border-red-600 font-medium text-lg px-6 py-2 border-b flex flex-row justify-center bg-red-600'>
								<div className='text-white text-xl font-bold'>{t('출금')}</div>
							</div>
									...
									<div className='grid grid-cols-2'>
										<div className='form-group mb-2 flex'>
											<div className='flex flex-row items-center'>
												<div
													className={`text-gray-500 mr-1 text-xs md:text-sm ${
