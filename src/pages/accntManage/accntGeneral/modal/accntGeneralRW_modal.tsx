...
interface IModalProps {
	setRWithDrawModal: React.Dispatch<React.SetStateAction<boolean>>;
}

export const AccntGenRWithDrawModal: React.FC<IModalProps> = ({
	setRWithDrawModal,
}) => {
	...
	const clickModalClose = () => {
		setRWithDrawModal((current) => !current);
	};
				...
				<div className='w-11/12 md:w-1/2 2xl:w-1/3 top-10 shadow-lg'>
					<div className=''>
						<div className='col-span-2 lg:col-span-2'>
							<div className='border rounded-t-md border-red-600 font-medium text-lg px-6 py-2 border-b flex flex-row justify-center bg-red-600'>
								<div className='text-white text-xl font-bold'>
									{t('보너스 출금')}
								</div>
							</div>
							<div className='p-6 grid rounded-b-md shadow-md bg-white'>
									...
									<div className='grid grid-cols-2'>
										...
										<div className='form-group mb-2 flex'>
											...
											<input
												...
												defaultValue={agentData?.balance_red.toLocaleString()}
											/>
										</div>
									</div>
									<div className='grid grid-cols-2'>
										...
										<div className='form-group mb-6 flex'>
											...
											<input
												...
												disabled
												className='bg-white pl-2 w-5/6 font-bold text-xs md:text-sm'
												defaultValue={subAccntData?.balance_red.toLocaleString()}
											/>
										</div>
									</div>
									<div className='grid grid-cols-2 gap-4'>
										<div className='mb-6 col-span-2 flex items-center '>
											...
											<input
												required
												type='text'
												max={subAccntData?.balance_default}
												min={0}
												value={enteredNum}
