...
export const GameBalSearchCopy = () => {
  ...
  const onSubmit = () => {
    ...
    if (!isValid) {
      ...
      EGM_HISTORY_SEARCH(searchFrom, searchTo, searchTo)
      ...
      >
        ...
        <div className="w-full sm:w-40">
          <select className="forminput" required>
            ...
            <option value="">{t('베팅')}</option>
            <option value="">{t('지급')}</option>
            <option value="">{t('게임취소')}</option>
            <option value="">{t('베팅취소')}</option>
            {/* <option value=''>정산</option>
              <option value=''>수정정산</option> */}
          </select>
        </div>
